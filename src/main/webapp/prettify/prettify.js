 ...
 */
    ...
    (function () {
        ...
        function L(a, d, f) {
            function b(a) {
                var c = a.nodeType;
                if (1 == c && !A.test(a.className))if ("br" === a.nodeName)v(a), a.parentNode && a.parentNode.removeChild(a); else for (a = a.firstChild; a; a = a.nextSibling)b(a); else if ((3 == c || 4 == c) && f) {
        ...
        t(y({
            keywords: P, hashComments: !0, cStyleComments: !0,
            verbatimStrings: !0, types: S
        }), ["cs"]);
        ...
        var Y = E.PR = {
            ...
            prettyPrintOne: E.prettyPrintOne = function (a, d, f) {
                ...
                f && L(b, f, !0);
                M({
                    j: d, m: f, h: b, l: 1, a: null, i: null, c: null,
                    g: null
                });
                return b.innerHTML
            },
                ...
                function f() {
                    for (var b = E.PR_SHOULD_USE_CONTINUATION ? c.now() + 250 : Infinity; p < t.length && c.now() < b; p++) {
                        ...
                        if ((l !== g || r.test(m)) && !e.test(m)) {
                            n = !1;
                            for (u = d.parentNode; u; u = u.parentNode)if (q.test(u.tagName) &&
                            ...
                            if (!n) {
                                ...
                                if (y.test(d.tagName))u = 1; else var u = d.currentStyle, x = v.defaultView, u = (u = u ? u.whiteSpace : x && x.getComputedStyle ? x.getComputedStyle(d, null).getPropertyValue("white-space") : 0) && "pre" === u.substring(0, 3);
                                x = l.linenums;
