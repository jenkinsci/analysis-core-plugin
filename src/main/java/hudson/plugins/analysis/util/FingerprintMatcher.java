...
public class FingerprintMatcher {
     ...
     *
     * @param pFingerprintOldWarnings an arraylist with the fingerprints of all old warnings
     * @param pFingerprintNewWarning the fingerprints of the new warning
     */
    public FingerprintMatcher(final List<WarningFingerprint> pFingerprintOldWarnings, final WarningFingerprint pFingerprintNewWarning) {
    ...
    public boolean match() {
        ...
        for (WarningFingerprint curOldWarning : mFingerPrintOldWarning) {
            ...
            if (curOldWarning.getType().equals(mFingerPrintNewWarning.getType()) && curOldWarning.getErrorLine().equals(mFingerPrintNewWarning.getErrorLine())) {
                ...
                if (((matchingRate > 0.5 &&  successiveMatchesRate > 0.3) || matchingRate > 0.7) && mFingerPrintNewWarning.getType().equals(curOldWarning.getType())) {
