...
public class AnalysisPublisher extends HealthAwarePublisher {
     ...
     *
     * @param healthy                   Report health as 100% when the number of annotations is less than this value
     * @param unHealthy                 Report health as 0% when the number of annotations is greater than this value
     * @param thresholdLimit            determines which warning priorities should be considered when evaluating the
     *                                  build stability and health
     * @param defaultEncoding           the default encoding to be used when reading and parsing files
     * @param useDeltaValues            determines whether the absolute annotations delta or the actual annotations set
     ...
     * @param isCheckStyleActivated     determines whether to collect the warnings from Checkstyle
     * @param isDryActivated            determines whether to collect the warnings from DRY
     * @param isFindBugsActivated       determines whether to collect the warnings from FindBugs
     * @param isPmdActivated            determines whether to collect the warnings from PMD
     * @param isOpenTasksActivated      determines whether to collect open tasks
     * @param isWarningsActivated       determines whether to collect compiler warnings
    ...
    /**
     * Initializes the plug-ins that should participate in the results of this analysis collector.
     *
    ...
    private List<Class<? extends ResultAction<? extends BuildResult>>> getParticipatingPlugins() {
        ...
        for (AnalysisPlugin plugin : getActivePlugins()) {
            pluginResults.addAll(plugin.getActions());
        }
