...
public abstract class HealthAwarePublisher extends HealthAwareRecorder {
     ...
     * @param workspace the workspace for this build
     * @param launcher  the launcher for this build
     * @param logger    the logger
     * @return <code>true</code> if the build can continue, <code>false</code> otherwise
     * @throws IOException          in case of problems during file copying
     * @throws InterruptedException if the user canceled the build
     */
    @Override
     ...
     *
     * @param result the evaluated build result
     * @param logger the logger
     */
     ...
     * @throws InterruptedException If the build is interrupted by the user (in an attempt to
     ...
     * @throws IOException          If the implementation wants to abort the processing when an
     ...
     *
     * @param healthy                     Report health as 100% when the number of open tasks is less
     *                                    than this value
     * @param unHealthy                   Report health as 0% when the number of open tasks is greater
     *                                    than this value
     ...
     * @param usePreviousBuildAsReference determine if the previous build should always be used as the
     ...
     *                                    respect to baseline)
     * @param canResolveRelativePaths     determines whether relative paths in warnings should be
