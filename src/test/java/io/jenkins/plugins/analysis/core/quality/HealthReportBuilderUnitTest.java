 ...
 */
class HealthReportBuilderUnitTest {

    /**
     * HealthReportBuilder should not return a HealthReport if HealthDescriptor is disabled.
     */
    @Test
    void shouldReturnNullWhenHealthDescriptorIsDisabled() {
     ...
     */
    @Test
    void shouldReturnScore100ForAllPriorities() {
     ...
     */
    @Test
    void shouldReturnScore0ForAllPriorities() {
     ...
     */
    @Test
    void shouldReturnScore20ForLowPriority() {
     ...
     */
    @Test
    void shouldReturnScore50ForNormalPriority() {
     ...
     */
    @Test
    void shouldReturnScore80ForHighPriority() {
     ...
     */
    @Test
    void shouldReturnHealthReportNoItemDescription() {
        HealthReportBuilder builder = createHealthReportBuilder(10, 20, Priority.LOW);
        HealthReport healthReport = builder.computeHealth(createPrioritySizeMap(0, 0, 0));
     ...
     */
    @Test
    void shouldReturnHealthReportSingleItemDescription() {
        HealthReportBuilder builder = createHealthReportBuilder(10, 20, Priority.LOW);
     ...
     */
    @Test
    void shouldReturnHealthReportMultipleItemDescription() {
        HealthReportBuilder builder = createHealthReportBuilder(10, 20, Priority.LOW);
